...
struct HelpUsViewModel {
    ...
    private let sharingText: [String] = [
        NSLocalizedString(
            ...
            value: "Here is the app I use to store my CLC and ERC20 tokens.",
            comment: ""
        ),
        NSLocalizedString(
            "welldone.viewmodel.sharing.text2",
            value: "Check out ContractLand - the wallet that lets me securely store my CLC tokens.",
            comment: ""
        ),
        NSLocalizedString(
            "welldone.viewmodel.sharing.text3",
            value: "I securely store Ethereum and ERC20 tokens in the ContractLand wallet",
            comment: ""
        ),
        NSLocalizedString(
            "welldone.viewmodel.sharing.text4",
            value: "I secure my Ethereum and ERC20 tokens in the ContractLand wallet.",
            comment: ""
        ),
    ]
