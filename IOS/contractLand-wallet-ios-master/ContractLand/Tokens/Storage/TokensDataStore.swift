...
//7.8.2019 modify coin present
extension Coin {
    var server: RPCServer {
        switch self {
        case .bitcoin: return RPCServer.main //TODO
            case .terra: return RPCServer.main
        case .ethereum: return RPCServer.terra
        case .ethereumClassic: return RPCServer.terra
        case .gochain: return RPCServer.terra
        case .callisto: return RPCServer.main
